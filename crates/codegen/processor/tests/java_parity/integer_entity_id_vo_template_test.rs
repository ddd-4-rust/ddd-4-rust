//! `integer_entity_id_vo_template_test` 模块承载同名 Java 类型迁移后的 Rust 领域实现；文件名保持 `snake_case`，公开类型保持 `PascalCase`。
//!
//! Java source: `codegen/processor/src/test/java/org/fuin/ddd4j/codegen/processor/IntegerEntityIdVOTemplateTest.java`.
