...
//!
//! Java source: `jackson/src/main/java/org/fuin/ddd4j/jackson/AggregateVersionConflictExceptionData.java`.
...
pub type AggregateVersionConflictExceptionData =
    crate::json::serde::AggregateVersionConflictExceptionData;
