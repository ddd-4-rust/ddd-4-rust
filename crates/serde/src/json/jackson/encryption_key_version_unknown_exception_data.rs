...
//!
//! Java source: `jackson/src/main/java/org/fuin/ddd4j/jackson/EncryptionKeyVersionUnknownExceptionData.java`.
...
pub type EncryptionKeyVersionUnknownExceptionData =
    crate::json::serde::EncryptionKeyVersionUnknownExceptionData;
