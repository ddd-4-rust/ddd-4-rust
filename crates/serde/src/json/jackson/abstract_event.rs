...
//!
//! Java source: `jackson/src/main/java/org/fuin/ddd4j/jackson/AbstractEvent.java`.

/// Legacy alias backed by the Serde-native API.
///
/// `AbstractEvent` 是迁移兼容层公开的稳定类型别名。
/// 该别名不复制底层数据，用于保持 Java 来源类型与 Rust 公共路径的一一对应关系。
pub type AbstractEvent = crate::json::serde::AbstractEvent;
