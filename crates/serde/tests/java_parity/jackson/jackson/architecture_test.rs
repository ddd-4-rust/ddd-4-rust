...
//!
//! Java source: `jackson/src/test/java/org/fuin/ddd4j/jackson/ArchitectureTest.java`.
...
fn java_scenario_1() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jackson", "ArchitectureTest", 1)
}
...
fn java_scenario_2() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jackson", "ArchitectureTest", 2)
}
