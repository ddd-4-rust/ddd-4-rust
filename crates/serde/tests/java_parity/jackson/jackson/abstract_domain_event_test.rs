...
//!
//! Java source: `jackson/src/test/java/org/fuin/ddd4j/jackson/AbstractDomainEventTest.java`.
...
fn java_scenario_1() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jackson", "AbstractDomainEventTest", 1)
}
...
fn java_scenario_2() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jackson", "AbstractDomainEventTest", 2)
}
...
fn java_scenario_3() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jackson", "AbstractDomainEventTest", 3)
}
...
fn java_scenario_4() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jackson", "AbstractDomainEventTest", 4)
}
...
fn java_scenario_5() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jackson", "AbstractDomainEventTest", 5)
}
...
fn java_scenario_6() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jackson", "AbstractDomainEventTest", 6)
}
