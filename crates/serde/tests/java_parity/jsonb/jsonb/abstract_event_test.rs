...
//!
//! Java source: `jsonb/src/test/java/org/fuin/ddd4j/jsonb/AbstractEventTest.java`.
...
fn java_scenario_1() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "AbstractEventTest", 1)
}
...
fn java_scenario_2() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "AbstractEventTest", 2)
}
...
fn java_scenario_3() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "AbstractEventTest", 3)
}
...
fn java_scenario_4() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "AbstractEventTest", 4)
}
...
fn java_scenario_5() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "AbstractEventTest", 5)
}
...
fn java_scenario_6() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "AbstractEventTest", 6)
}
