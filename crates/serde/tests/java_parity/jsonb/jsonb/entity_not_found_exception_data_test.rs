...
//!
//! Java source: `jsonb/src/test/java/org/fuin/ddd4j/jsonb/EntityNotFoundExceptionDataTest.java`.
...
fn java_scenario_1() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "EntityNotFoundExceptionDataTest", 1)
}
...
fn java_scenario_2() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "EntityNotFoundExceptionDataTest", 2)
}
...
fn java_scenario_3() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "EntityNotFoundExceptionDataTest", 3)
}
...
fn java_scenario_4() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "EntityNotFoundExceptionDataTest", 4)
}
