...
//!
//! Java source: `jsonb/src/test/java/org/fuin/ddd4j/jsonbtest/VendorExampleTest.java`.
...
fn java_scenario_1() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "VendorExampleTest", 1)
}
...
fn java_scenario_2() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "VendorExampleTest", 2)
}
...
fn java_scenario_3() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jsonb", "VendorExampleTest", 3)
}
