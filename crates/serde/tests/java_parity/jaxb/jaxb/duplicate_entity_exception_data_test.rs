...
//!
//! Java source: `jaxb/src/test/java/org/fuin/ddd4j/jaxb/DuplicateEntityExceptionDataTest.java`.
...
fn java_scenario_1() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "DuplicateEntityExceptionDataTest", 1)
}
...
fn java_scenario_2() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "DuplicateEntityExceptionDataTest", 2)
}
...
fn java_scenario_3() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "DuplicateEntityExceptionDataTest", 3)
}
...
fn java_scenario_4() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "DuplicateEntityExceptionDataTest", 4)
}
