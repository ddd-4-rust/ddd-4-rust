...
//!
//! Java source: `jaxb/src/test/java/org/fuin/ddd4j/jaxb/DecryptionFailedExceptionDataTest.java`.
...
fn java_scenario_1() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "DecryptionFailedExceptionDataTest", 1)
}
...
fn java_scenario_2() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "DecryptionFailedExceptionDataTest", 2)
}
...
fn java_scenario_3() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "DecryptionFailedExceptionDataTest", 3)
}
...
fn java_scenario_4() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "DecryptionFailedExceptionDataTest", 4)
}
