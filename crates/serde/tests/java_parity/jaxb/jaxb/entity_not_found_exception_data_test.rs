...
//!
//! Java source: `jaxb/src/test/java/org/fuin/ddd4j/jaxb/EntityNotFoundExceptionDataTest.java`.
...
fn java_scenario_1() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "EntityNotFoundExceptionDataTest", 1)
}
...
fn java_scenario_2() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "EntityNotFoundExceptionDataTest", 2)
}
...
fn java_scenario_3() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "EntityNotFoundExceptionDataTest", 3)
}
...
fn java_scenario_4() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "EntityNotFoundExceptionDataTest", 4)
}
