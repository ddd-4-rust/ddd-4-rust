...
//!
//! Java source: `jaxb/src/test/java/org/fuin/ddd4j/jaxb/AbstractDomainEventTest.java`.
...
fn java_scenario_1() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "AbstractDomainEventTest", 1)
}
...
fn java_scenario_2() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "AbstractDomainEventTest", 2)
}
...
fn java_scenario_3() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "AbstractDomainEventTest", 3)
}
...
fn java_scenario_4() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "AbstractDomainEventTest", 4)
}
...
fn java_scenario_5() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "AbstractDomainEventTest", 5)
}
...
fn java_scenario_6() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "AbstractDomainEventTest", 6)
}
