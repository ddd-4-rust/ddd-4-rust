...
//!
//! Java source: `jaxb/src/test/java/org/fuin/ddd4j/jaxbtest/VendorExampleTest.java`.
...
fn java_scenario_1() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "VendorExampleTest", 1)
}
...
fn java_scenario_2() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "VendorExampleTest", 2)
}
...
fn java_scenario_3() -> Result<(), Box<dyn std::error::Error>> {
    run_scenario("jaxb", "VendorExampleTest", 3)
}
